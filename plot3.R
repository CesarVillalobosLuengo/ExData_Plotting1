...
## STEP: Create the third Plot in the windows screen and then output in PNG File (width=480, height=480)
 
 plot(subDataSet$DateTime, subDataSet$Sub_metering_1, type="l", ylab= "Energy sub metering", xlab="")
 lines(subDataSet$DateTime, subDataSet$Sub_metering_2, type="l", col="red")
 lines(subDataSet$DateTime, subDataSet$Sub_metering_3, type="l", col="blue")
